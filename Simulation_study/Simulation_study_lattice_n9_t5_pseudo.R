SS=1 #SS=50 for complete simulation study

for(ss in 1:SS){
  #Dataset generated for exchange
  setwd("~/Desktop/Phd_proj/Repository lavori/Spatio-temporal")
  load(paste0("~/Desktop/Phd_proj/Progetto UCD/R_results/Lattice_correction/n9t5/Sim_lattice_k2_n9_t5_sigmasqrt1_rv_r5_",ss,".Rdata"))  
  ...
  save.image(paste0("Sim_lattice_k2_n9_t5_sigmasqrt1_pseudo_",ss,".Rdata"))
  rm(list = ls())
}
