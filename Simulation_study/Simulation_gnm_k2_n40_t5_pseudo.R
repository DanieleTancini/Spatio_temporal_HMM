...
Simu = 1 #50 form complete simulation study

for(ss in 1:Simu){
  #Dataset generated for exchange
  setwd("~/Desktop/Phd_proj/Repository lavori/Spatio-temporal")
  load(paste0("~/Desktop/Phd_proj/Progetto UCD/R_results/n40t5/Sim_Gnm_k2_n40_t5_sigmasqrt1_rv_r5_number_",ss,".Rdata"))  
  ...
  save.image(paste0("Sim_Gnm_k2_n40_t5_sigmasqrt1_rv_pseudo_number_",ss,".Rdata"))
  rm(list = ls())
}
