...
Simu = 1 #50 complete simulation study

for(ss in 1:Simu){
  #Dataset generated for exchange
  setwd("~/Desktop/Phd_proj/Repository lavori/Spatio-temporal")
  load(paste0("~/Desktop/Phd_proj/Progetto UCD/R_results/n40t5k3/Sim_Gnm_k3_n40_t5_sigmasqrt1_rv_r5_number_prova_",ss,".Rdata"))  
  ...
  #Parameters
  Gamma_ = 4*matrix(c(0,-1/2,-1/2,-1/2,0,-1/2,-1/2,-1/2,0), 3,3) #in quello online abbiamo 2 invece che 4
  Delta_ = matrix(c(0,-1,-1,-1,0,-1,-1,-1,0), 3,3)
  Beta_ = c(0,0,0)
  Gammas_ = 4*matrix(c(0,-1/2,-1/2,-1/2,0,-1/2,-1/2,-1/2,0), 3,3) #in quello online abbiamo 2 invece che 4
  Betas_ = c(0,0,0)
  ...
  save.image(paste0("Sim_Gnm_k3_n40_t5_sigmasqrt1_rv_pseudo_number_",ss,".Rdata"))
  rm(list = ls())
}
