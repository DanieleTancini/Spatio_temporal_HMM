...
for(ss in 1:Simu){
  ...
  load(paste0("~/Desktop/Phd_proj/Progetto UCD/R_results/n40t10/Sim_Gnm_k2_n40_t10_sigmasqrt1_rv_r5_number_",ss,".Rdata"))  
  ...
  save.image(paste0("Sim_Gnm_k2_n40_t10_sigmasqrt1_rv_pseudo_number_",ss,".Rdata"))
  rm(list = ls())
}
